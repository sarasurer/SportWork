...
import 'package:sport_tv_app/squat1.dart';
import 'package:sport_tv_app/squat2.dart';
import 'package:sport_tv_app/squat3.dart';
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const SquatFirst()),
                          );
                        },
                        child: Container(
                          width: 164.9,
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const SquatSecond()),
                          );
                        },
                        child: Container(
                          width: 164.89,
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const SquatThird()),
                          );
                        },
                        child: Container(
                          width: 163,
