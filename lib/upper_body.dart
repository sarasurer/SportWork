...
import 'package:sport_tv_app/upper_body1.dart';
import 'package:sport_tv_app/upper_body2.dart';
import 'package:sport_tv_app/upper_body3.dart';
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const UpperBodyFirst()),
                          );
                        },
                        child: Container(
                          width: 164.9,
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const UpperBodySecond()),
                          );
                        },
                        child: Container(
                          width: 164.89,
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const UpperBodyThird()),
                          );
                        },
                        child: Container(
                          width: 163,
